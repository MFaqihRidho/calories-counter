...
export default {
    data() {
        return { data: [], value: '', error: false, errorValue: "", success: false }
    },
    methods: {
        fetchData() {
            axios.get(`https://trackapi.nutritionix.com/v2/search/instant?query=${this.value}`, {
                headers: {
                    'x-app-id': "9ff7947b",
        ...
        handleClickDetailsBranded(value) {
            console.log(value)
            axios.get(`https://trackapi.nutritionix.com/v2/search/item?nix_item_id=${value}`, {
                headers: {
                    'x-app-id': "9ff7947b",
                    'x-app-key': "50c66e23b3793fd3558d8af37c07c910",
                },
