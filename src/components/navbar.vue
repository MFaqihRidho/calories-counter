<template>
  ...
  >
    ...
    <div class="flex md:flex-col flex-row gap-14 md:gap-10">
      ...
      <router-link active-class="active" class="text-gray-400" to="/search">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="h-8 w-8"
          viewBox="0 0 20 20"
      ...
      <router-link active-class="active" class="text-gray-400" to="/about">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="h-8 w-8"
          viewBox="0 0 20 20"
      ...
      <router-link active-class="active" class="text-gray-400" to="/setting">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="h-8 w-8"
          viewBox="0 0 20 20"
